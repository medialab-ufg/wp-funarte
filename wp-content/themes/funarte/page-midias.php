...
<main role="main">
	<div class="container">
		...
		<div class="box-social-media" style="display: flex; justify-content: space-between;">
			<div class="box-twitter" style="width: 100%; max-width: 30%; max-height: 500px; overflow-y: auto; margin-bottom: 50px; ">
			...
			<div class="box-facebook" style="width: 100%; max-width: 30%; max-height: 500px; overflow-y: auto; margin-bottom: 50px; ">
				<div id="fb-root"></div>
