		...
		<div class="box-pagination__control">
			<?php /** Previous and Next Post Link */
				if ( get_previous_posts_link() ) {
					printf( '<button type="button" class="control__previous">%s</button>', get_previous_posts_link( '<i class="mdi mdi-chevron-left"></i>' ) );
				}
				if ( get_next_posts_link() ) {
					printf( '<button type="button" class="control__previous">%s</button>', get_next_posts_link( '<i class="mdi mdi-chevron-right"></i>' ) );
				}
			?>
		</div>
	</div>
