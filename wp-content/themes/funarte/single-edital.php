	...
	if (have_posts()) { the_post(); ?>
		<main role="main">
			...
			<div class="container">
				...
				<div class="box-title">
					<h2 class="title-h1"><a href="<?php echo get_bloginfo('url') . '/editais'; ?>">Editais</a> <a href="<?php echo get_bloginfo('url') . '/editais/?status=' . $status; ?>"><span><?php echo $edital->get_edital_status_name($post->ID); ?></span></a></h2>
				</div>
